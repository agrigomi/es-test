...
## IPC SchemaThe client and server create their own SHM areas:*   **Server SHM**: Used only to accept client connections.*   **Client SHM**: The client creates a unique named (including PID) SHM area used for data transfer.
